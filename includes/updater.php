<?php
/* Load Class. */
$fxUpdater_comoCustomHeader_Updater = new fxUpdater_comoCustomHeader_Updater();
/**
 * Updater Class
**/
class fxUpdater_comoCustomHeader_Updater{
	/**
	 * Class Constructor
	 */
	public function __construct() {
		...
		$this->config = array(
			...
			'type'    => 'plugin',
			'id'      => 'como-customheader/como-customheader.php',
			'api'     => '1.0.7',
			'post'    => array(),
		);
		/* Admin Init */
